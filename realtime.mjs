...
export async function startRealtime({ onChange, onStatus } = {}) {
  ...
  try {
    ...
    for (const table of ["projects", "levels", "materials", "deliveries", "spruce_orders", "spruce_order_items", "inventory_materials", "purchase_orders", "incoming_orders", "activity_log"]) {
      channel.on(
        "postgres_changes",
